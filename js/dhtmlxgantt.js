...
gantt = {version: "4.0.0"}, gantt.event = function (t, e, n) {
    ...
    if (!this._isAllowedUnscheduledTask(t)) {
        ...
        var l = ["left:" + (e.x + 2) + "px", "top:" + (i + e.y) + "px", "height:" + a + "px", "line-height:" + a + "px", "width:" + r + "px"];
...
gantt._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>",gantt.showLightbox = function (t) {
    ...
    if (this._y = t.innerHeight, !(this._y < 20)) {
        ...
        this.$grid.style.width = n + "px", this.$grid.style.display = 0 === n ? "none" : "", t = this._get_box_styles(), this._x = t.innerWidth, this._x < 20 || (this.$grid_data.style.width = Math.max(this._get_grid_width() - 1, 0) + "px", this.$task.style.height = Math.max(this._y - this._get_grid_width() - 2, 0) + "px")
    }
